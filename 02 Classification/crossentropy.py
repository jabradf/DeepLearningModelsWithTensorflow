'''
Before we continue loading the data and designing the model, we need to talk about cross-entropy, an important concept for 
evaluating classification model training. Cross-entropy is a score that summarizes the average difference between the actual and 
predicted probability distributions for all classes. The goal is to minimize the score, with a perfect cross-entropy value is 0.
'''
